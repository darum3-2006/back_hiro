...
export class AddTasks1777970370308 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE \`tasks\` ADD CONSTRAINT \`FK_6986464882b1c808a059425f37d\` FOREIGN KEY (\`assignee_member_id\`) REFERENCES \`project_members\`(\`id\`) ON DELETE SET NULL ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE \`tasks\` ADD CONSTRAINT \`FK_ba79db435f613f6b337c6d45069\` FOREIGN KEY (\`requester_member_id\`) REFERENCES \`project_members\`(\`id\`) ON DELETE SET NULL ON UPDATE NO ACTION`);
    }

    public async down(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`ALTER TABLE \`tasks\` DROP FOREIGN KEY \`FK_ba79db435f613f6b337c6d45069\``);
        await queryRunner.query(`ALTER TABLE \`tasks\` DROP FOREIGN KEY \`FK_6986464882b1c808a059425f37d\``);
        await queryRunner.query(`ALTER TABLE \`tasks\` DROP FOREIGN KEY \`FK_9eecdb5b1ed8c7c2a1b392c28d4\``);
        await queryRunner.query(`ALTER TABLE \`task_tags\` DROP FOREIGN KEY \`FK_f883135d033e1541f6a81972e7d\``);
        await queryRunner.query(`ALTER TABLE \`task_tags\` DROP FOREIGN KEY \`FK_70515bc464901781ac60b82a1ea\``);
