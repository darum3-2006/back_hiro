...
export class AddComments1777972387469 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE \`comments\` ADD CONSTRAINT \`FK_6a2277f82bb16e2e1f50571893d\` FOREIGN KEY (\`author_member_id\`) REFERENCES \`project_members\`(\`id\`) ON DELETE SET NULL ON UPDATE NO ACTION`);
    }

    public async down(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`ALTER TABLE \`comments\` DROP FOREIGN KEY \`FK_6a2277f82bb16e2e1f50571893d\``);
        await queryRunner.query(`ALTER TABLE \`comments\` DROP FOREIGN KEY \`FK_18c2493067c11f44efb35ca0e03\``);
        await queryRunner.query(`ALTER TABLE \`comments\` DROP FOREIGN KEY \`FK_03dbde2ff570596e874bb3bb311\``);
