...
export const MOCK_TASKS: Task[] = [
  ...
  },
  {
    ...
    requesterMemberId: 'm5',
    requestingDeptCode: 'accounting',
    assigneeMemberId: 'm8',
    priorityCode: 'high',
  ...
  },
  {
    ...
    links: [],
    requesterMemberId: 'm6',
    requestingDeptCode: 'cs',
    assigneeMemberId: 'm7',
    priorityCode: 'high',
    statusCode: 'in_progress',
    deadline: '2026-05-07',
  ...
  },
  {
    ...
    requesterMemberId: 'm9',
    requestingDeptCode: 'sales',
    assigneeMemberId: 'm1',
    priorityCode: 'mid',
    statusCode: 'todo',
    deadline: '2026-05-15',
  ...
  // ===== p2: 新規開発 =====
  {
    ...
    requesterMemberId: 'm13',
    requestingDeptCode: 'biz_dev',
    assigneeMemberId: 'm15',
    priorityCode: 'p1',
    statusCode: 'design',
    deadline: '2026-05-30',
  ...
  },
  {
    ...
    links: [],
    requesterMemberId: 'm21',
    requestingDeptCode: 'biz_dev',
    assigneeMemberId: 'm19',
    priorityCode: 'p2',
    statusCode: 'todo',
    deadline: '2026-06-15',
    plannedCompletionDate: null,
  ...
  },
  {
    ...
    requesterMemberId: 'm14',
    requestingDeptCode: 'biz_dev',
    assigneeMemberId: 'm16',
    priorityCode: 'p0',
    statusCode: 'dev',
    deadline: '2026-05-22',
  ...
  },
  {
    ...
    requesterMemberId: 'm17',
    requestingDeptCode: 'marketing',
    assigneeMemberId: 'm20',
    priorityCode: 'p1',
    statusCode: 'review',
    deadline: '2026-05-15',
  ...
  },
  {
    ...
    links: [],
    requesterMemberId: 'm18',
    requestingDeptCode: 'biz_dev',
    assigneeMemberId: 'm13',
    priorityCode: 'p1',
    statusCode: 'design',
    deadline: '2026-05-28',
    plannedCompletionDate: null,
  ...
  // ===== p3: リファクタリング =====
  {
    ...
    requesterMemberId: 'm31',
    requestingDeptCode: 'system',
    assigneeMemberId: 'm25',
    priorityCode: 'high',
    statusCode: 'doing',
    deadline: '2026-05-25',
  ...
  },
  {
    ...
    links: [],
    requesterMemberId: 'm32',
    requestingDeptCode: 'system',
    assigneeMemberId: 'm29',
    priorityCode: 'low',
    statusCode: 'todo',
    deadline: '2026-06-30',
    plannedCompletionDate: null,
